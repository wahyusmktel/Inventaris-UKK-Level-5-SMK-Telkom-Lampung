...
if (isset($_GET['id'])) {
    ...
    // 5. Query untuk mengambil data user yang spesifik
    $query_data = "SELECT * FROM tbl_user WHERE id_user = '$id_user'";
...
<head>
    ...
    <title>Edit User - Inventaris</title>
...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="barang.php"><i class="fas fa-fw fa-box"></i><span>Data Barang</span></a>
            </li>
            <li class="nav-item">
            ...
            <?php if (isset($_SESSION['level']) && $_SESSION['level'] == 'admin') : ?>
                ...
                <li class="nav-item active"> <a class="nav-link" href="user.php"><i class="fas fa-fw fa-users"></i><span>Manajemen User</span></a>
                </li>
            <?php endif; ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Ubah data user yang sudah ada.</p>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <small class="form-text text-muted">
                                            *Kosongkan saja jika tidak ingin mengubah password.
                                        </small>
                                    </div>
                                </div>
