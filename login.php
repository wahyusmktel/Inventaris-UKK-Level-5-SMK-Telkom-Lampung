...
<head>
    ...
    <meta name="description" content="Aplikasi Inventaris Barang UKK">
    ...
    <style>
        /* Kita set background-nya simpel saja, tidak pakai gambar */
        .bg-login-custom {
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Aplikasi Inventaris</h1>
                                        <p>Silakan Login</p>
                                    </div>
